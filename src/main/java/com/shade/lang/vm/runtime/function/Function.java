...
public class Function extends AbstractFunction {
    ...
    public Function(Module module, String name, ByteBuffer chunk, String[] constants, Map<Integer, Region.Span> lines, Assembler.Guard[] guards, int arguments, int locals) {
        super(module, name);
        this.chunk = chunk;
