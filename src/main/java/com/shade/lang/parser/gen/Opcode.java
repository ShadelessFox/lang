...
public class Opcode {
    ...
    /* Branching */
    public static final byte JUMP          = 0x0D;
    public static final byte IF_EQ         = 0x0E;
    public static final byte IF_NE         = 0x0F;
    public static final byte IF_LT         = 0x10;
    public static final byte IF_LE         = 0x11;
    public static final byte IF_GT         = 0x12;
    public static final byte IF_GE         = 0x13;

    /* Invocation */
    public static final byte CALL          = 0x14;
    public static final byte RET           = 0x15;
    public static final byte POP           = 0x16;
